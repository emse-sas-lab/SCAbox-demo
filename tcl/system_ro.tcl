...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
emse.sas:sca:aes:1.0\
xilinx.com:ip:clk_wiz:6.0\
emse.sas:sca:fifo_ctrl:1.0\
xilinx.com:ip:fifo_generator:13.2\
xilinx.com:ip:processing_system7:5.5\
emse.sas:sca:ro_bank:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ro_bank_0, and set properties
  set ro_bank_0 [ create_bd_cell -type ip -vlnv emse.sas:sca:ro_bank:1.0 ro_bank_0 ]
  set_property -dict [ list \
   CONFIG.count_g {16} \
 ] $ro_bank_0
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins aes_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins ro_bank_0/S_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_acq [get_bd_pins clk_wiz_0/clk_acq] [get_bd_pins fifo_generator_0/wr_clk] [get_bd_pins ro_bank_0/clock_i]
  ...
  connect_bd_net -net fifo_ctrl_0_threshold_o [get_bd_pins fifo_ctrl_0/threshold_o] [get_bd_pins fifo_generator_0/prog_full_thresh]
  connect_bd_net -net fifo_ctrl_0_write_o [get_bd_pins fifo_ctrl_0/write_o] [get_bd_pins fifo_generator_0/wr_en]
  connect_bd_net -net fifo_generator_0_dout [get_bd_pins fifo_ctrl_0/data_i] [get_bd_pins fifo_generator_0/dout]
  ...
  connect_bd_net -net fifo_generator_0_prog_full [get_bd_pins fifo_ctrl_0/reached_i] [get_bd_pins fifo_generator_0/prog_full]
  connect_bd_net -net fifo_generator_0_wr_data_count [get_bd_pins fifo_ctrl_0/count_i] [get_bd_pins fifo_generator_0/wr_data_count]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins aes_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins fifo_ctrl_0/clock_i] [get_bd_pins fifo_ctrl_0/s_axi_aclk] [get_bd_pins fifo_generator_0/rd_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ro_bank_0/s_axi_aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net ro_bank_0_data_o [get_bd_pins fifo_generator_0/din] [get_bd_pins ro_bank_0/data_o]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins aes_0/s_axi_aresetn] [get_bd_pins fifo_ctrl_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ro_bank_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ro_bank_0/S_AXI/S_AXI_reg] -force
